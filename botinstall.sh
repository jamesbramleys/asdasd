...
class DetectionEngine:
    ...
    def _check_proxy_vpn(self, ip):
        ...
        score, reasons = 0, []
        try:
            r = requests.get(f"http://ip-api.com/json/{ip}?fields=proxy,hosting", timeout=3)
...
DETECTORPHP
    ...
    print_success "PHP integration: $PROJECT_DIR/php-integration/config.php + detector.php"
}
